...
int main(){
    ...
    /*  Input: 1 2 -1 -1 3 -1 -1
        ...
        Explanation: Node 1 is at <0> and Node 2 is at <-1> and Node 4 is at <-2>....
                    now we calculate its horizontal distance from root and if any hd <> have more than one node than discard the others one because first node hide the others upcomming node like: <0> have 1, 5, 6 so discard 5 and 6 i.e.
    ...
    */
    ...
    /* Input: 10 20 40 -1 -1 60 -1 -1 30 90 -1 -1 100 -1 -1
                               10
                            /      \
                          20        30
                         /   \     /    \
